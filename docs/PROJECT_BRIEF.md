...
- Chạm một project dot trước task/note sẽ mở hoặc thu gọn đồng loạt mọi project dot trong view thành pill nhỏ hiển thị tên dự án uppercase với regular weight. Khi mở, pill chỉ ôm tên dự án nhưng nằm trong một cột chung theo pill dài nhất để mọi title vẫn thẳng hàng; dot giữ nguyên trục khi co giãn. Pill tham gia layout, không overlay hoặc dùng shadow; trạng thái mở và tùy chọn bật/tắt được giữ khi đổi view và lưu riêng theo browser.
